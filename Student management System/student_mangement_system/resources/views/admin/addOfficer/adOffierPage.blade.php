...
<div class="MainSectionContainer">
        ...
        <div class="row mainSectionStart">
            <div class="col-lg-3 mainSectionLeft">
                ...
                <img src="{{ asset('uploads/adofficer') }}/{{ Auth::guard('addofficerguard')->user()->photo }}" alt=""
                ...
                <div class="modal fade AdoffModel" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('adOfficerPicUpload') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">

                                    <img src="{{ asset('uploads/adofficer') }}/{{ Auth::guard('addofficerguard')->user()->photo }}"
                                        alt="" class="adOffiCierProfilePic" width="300px" height="300px"
                                        id="adOfficerProfileImg">
                                    <input type="file" class="form-control mt-3" name="addadOfficerProfileup"
                                        onchange="document.getElementById('adOfficerProfileImg').src = window.URL.createObjectURL(this.files[0])">


                                    <input type="hidden" value="{{ Auth::guard('addofficerguard')->user()->name }}"
                                        name="adOfficerName">
                ...
                <div class="d-flex bd-highlight mobileDiv">
                    ...
                    <p class="mobileNumber flex-grow-1 bd-highlight"><span><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            </svg></span> {{ Auth::guard('addofficerguard')->user()->phoneNum }}</p>
                ...
                <div class="d-flex bd-highlight emailDiv">
                    ...
                    <p class="email flex-grow-1 bd-highlight"><span><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            </svg></span> {{ Auth::guard('addofficerguard')->user()->email }}</p>
            ...
            <div class="col-lg-8 mainSectionRight">
                ...
                <form action="{{ route('adOfficerInfoUpdate') }}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ Auth::guard('addofficerguard')->user()->name }}" name="Name">
                            </div>

                            <input type="hidden" name="teacherHiddenId"
                                value="{{ Auth::guard('addofficerguard')->id() }}">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control"
                                value="{{ Auth::guard('addofficerguard')->user()->fatherName }}" name="FatherName">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control"
                                value="{{ Auth::guard('addofficerguard')->user()->motherName }}" name="MotherName">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="number" class="form-control"
                                value="{{ Auth::guard('addofficerguard')->user()->nationalid }}" name="NationalId">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="number" class="form-control"
                                value="{{ Auth::guard('addofficerguard')->user()->birthRegNum }}" name="BirthReg">
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control"
                                value="{{ Auth::guard('addofficerguard')->user()->dob }}" name="Dob">
                        ...
                        <div class="col-lg-2">
                            ...
                            <input type="text" class="form-control"
                                value="{{ Auth::guard('addofficerguard')->user()->bloodGrp }}" name="BloodGrp">
                        ...
                        <div class="col-lg-2">
                            ...
                            <input type="text" class="form-control"
                                value="{{ Auth::guard('addofficerguard')->user()->religion }}" name="Religion">
                        </div>
                        ...
                        <div class="col-lg-2">
                            ...
                            <input type="text" class="form-control"
                                value="{{ Auth::guard('addofficerguard')->user()->Gender }}" name="Gender">
                        </div>
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" class="form-control"
                                value="{{ Auth::guard('addofficerguard')->user()->Howtoknowaboutus }}" name="HoWTo">
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control"
                                value="{{ Auth::guard('addofficerguard')->user()->presentAddress }}" name="Present">
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control"
                                value="{{ Auth::guard('addofficerguard')->user()->parmanentAddress }}" name="Parmanant">
                        </div>
                        ...
                        @if (session('adOfficerupdateSuccess'))
                            <div class="alert alert-success">{{ session('adOfficerupdateSuccess') }}</div>
                        @endif
