...
@section('content')
    <div class="container-fluid">
        <form action="{{route("addOfficerInsert")}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mainContainer">
                ...
                <div class="col-lg-4 regLeftPart">
                    ...
                    <div class="leftPartRegStart">
                        ...
                        <legend>Admission Officer Registration </legend>
                    ...
                    <div class="rightPartRegStart">
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <select class="form-select @error('postion') is-invalid @enderror" name="postion">
                                ...
                                <option selected value="2">Admission Officer</option>
                        ...
                        @if (session("Reg_success_admission"))

                        <div class="alert alert-success">{{session("Reg_success_admission")}}</div>
