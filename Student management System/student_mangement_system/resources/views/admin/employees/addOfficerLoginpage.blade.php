        ...
        <div class="containerMain">
            <div class="row">
                <div class="col-lg-4 signInleftForm">
                    <h5 class="topHeading">Admission Officer Sign In</h5>
                    <div class="logo">
                    ...
                    <div class="mySignInForm">
                        <form action="{{route("adOfficerLoginCheck")}}" method="POST">
                            @csrf

                            @if (session("adOfficerLoginFailed"))
                             <div class="alert alert-danger">{{session("adOfficerLoginFailed")}}</div>    
                            @endif
                            
                            @if (session("adOfficerLoginFailedEmpty"))
                             <div class="alert alert-danger">{{session("adOfficerLoginFailedEmpty")}}</div>    
                            @endif
                            <div class="mb-3">
