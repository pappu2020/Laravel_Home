            ...
            <div class="navBarContainer">
                <div class="d-flex flex-row bd-highlight mb-3">
                    <div class="bd-highlight menu">
                        ...
                        <div class="offcanvas offcanvas-start myMenuBody" tabindex="-1" id="offcanvasExample"
                            ...
                            <div class="offcanvas-body">
                                ...
                                <a href="{{ route('adOffierPage') }}" class="menuListItem">
                                ...
                                <a href="{{ route('addOfficerOperationPage') }}" class="menuListItem">
                                    <div class=" bd-highlight menuListItemDiv">
                                ...
                                <a href="#" class="menuListItem">
                                    <div class=" bd-highlight menuListItemDiv">
                                        ...
                                        <p class="menuListItemParaTuition">Message</p>
                    ...
                    <div class=" bd-highlight">
                        <div class="logo">
                            <img src="{{ asset('dashboard_asset/img/logo2.JPG') }}" alt="" width="160px"
                                height="90px" class="logoImg">
                        </div>
                    </div>
                    ...
                    <div class=" bd-highlight">
                        <img src="{{ asset('uploads/adofficer') }}/{{ Auth::guard('addofficerguard')->user()->photo }}"
                            class="userImage rounded rounded-circle" alt="" width="50px" height="50px">
                    </div>
