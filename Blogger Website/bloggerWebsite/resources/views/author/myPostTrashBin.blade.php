...
@section('content')
    <span class="title_div">My Deleted Post</span>

    <div class="row">

        @forelse ($postTrashData as $authorPost)
            <div class="card rounded col-lg-5 myPostCard">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            <img class="img-xs rounded-circle"
                                src="{{ asset('uploads/userProfile') }}/{{ $authorPost->first()->rel_to_users->photo }}"
                                alt="">
                            <div class="ml-2">
                                <h5>{{ $authorPost->first()->rel_to_users->name }}</h5>
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{route("myPostRestore",$authorPost->id)}}">Restore</a>
                                <a class="dropdown-item" href="{{route("myPostParmanantDelete",$authorPost->id)}}">Parmanant Delete</a>
