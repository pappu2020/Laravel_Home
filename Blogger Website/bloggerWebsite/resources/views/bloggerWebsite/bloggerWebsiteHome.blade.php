                    ...
                    <div class="col-lg-12">
                        <div class="owl-carousel">
                            ...
                            @foreach ($allapprovedPost as $approvedPost)
                                <div class="blog-item"
                                    style="background-image: url('uploads/blogerPost/{{ $approvedPost->featured_img }}')">
                                    <div class="blog-banner">
                                        <div class="post-overly">
                                            <div class="post-overly-content">
                                                <div class="entry-cat">
                                                    <a href="{{ route('categoryWiseBlogPage', $approvedPost->rel_to_category->id) }}"
                                                        class="category-style-2">{{ $approvedPost->rel_to_category->categoryName }}</a>
                                                </div>
                                                <h2 class="entry-title">
                                                    <a href="{{ route('bloggerDetailsPage', $approvedPost->slug) }}">{{ $approvedPost->title }}
                                                    </a>
                                                </h2>
                                                <ul class="entry-meta">
                                                    <li class="post-author"> <a
                                                            href="{{ route('authorPage', $approvedPost->rel_to_users->id) }}">{{ $approvedPost->rel_to_users->name }}</a>
                                                    </li>
                                                    <li class="post-date"> <span
                                                            class="line"></span>{{ $approvedPost->created_at->format('d-m-Y') }}
                                                    </li>
                                                    <li class="post-timeread"> <span class="line"></span>
                                                        {{ $approvedPost->readTime }} mins read</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="categories-items">
                                ...
                                @foreach ($allCategory as $Category)
                                    <a class="category-item" href="{{ route('categoryWiseBlogPage', $Category->id) }}">
                                        <div class="image">
                                            <img src="{{ asset('uploads/category') }}/{{ $Category->categoryImg }}"
                                                alt="">
                                        </div>
                                        <p>{{ $Category->categoryName }}
                                            <span>{{ App\Models\bloggerPostModel::where('category_id', $Category->id)->count() }}</span>
                                        </p>
                                    </a>
                                @endforeach
                                ...
                                <div class="post-list post-list-style4">
                                    <div class="post-list-image">
                                        <a href="{{ route('bloggerDetailsPage', $RecentArticles->slug) }}">
                                            <img src="{{ asset('uploads/blogerPost') }}/{{ $RecentArticles->featured_img }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="post-list-content">
                                        <ul class="entry-meta">
                                            <li class="entry-cat">
                                                <a href="{{ route('categoryWiseBlogPage', $RecentArticles->rel_to_category->id) }}"
                                                    class="category-style-1">{{ $RecentArticles->rel_to_category->categoryName }}</a>
                                            </li>
                                            <li class="post-date"> <span class="line"></span>
                                                {{ $RecentArticles->created_at->format('d-m-Y') }}</li>
                                        </ul>
                                        <h5 class="entry-title">
                                            <a
                                                href="{{ route('bloggerDetailsPage', $RecentArticles->slug) }}">{{ $RecentArticles->title }}</a>
                                        </h5>
                            ...
                            <div class="sidebar">
                                ...
                                <div class="widget">
                                    ...
                                    <div class=" widget-search">
                                        <form action="">
                                            <input type="search" id="search_input_home" value="{{ @$_GET['q'] }}"
                                                placeholder="Search ....">
                                            <button class="btn-submit" type="button" id="search_btn_home"><i
...
<script>
    $("#search_btn_home").click(function() {
        var searchValue = $("#search_input_home").val();
