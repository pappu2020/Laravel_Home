...
Route::get("webpagecontactPageView", [contactController::class, "webpagecontactPageView"])->name("webpagecontactPageView");
Route::post("contactInfoInsert", [contactController::class, "contactInfoInsert"])->name("contactInfoInsert");




Route::get("contactPageView",[pagecontactController::class, "contactPageView"])->name("contactPageView");
Route::post("pageContactInsert",[pagecontactController::class, "pageContactInsert"])->name("pageContactInsert");
Route::get("pagecontactEditPage/{contactId}", [pagecontactController::class, "pagecontactEditPage"])->name("pagecontactEditPage");
Route::post("pagecontactEdit", [pagecontactController::class, "pagecontactEdit"])->name("pagecontactEdit");
