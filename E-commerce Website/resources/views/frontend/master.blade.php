...
<body>
                            ...
                            @auth('customerLogin')
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{ route('customerProfile') }}">Profile</a>
                                    ...
                                    <li>
                                        <a href="#" onclick="openWishlist()">
                                            <i class="far fa-heart fs-lg"></i><span
                                                class="dn-counter bg-success">{{ App\Models\wishlistModel::where('customer_id', Auth::guard('customerLogin')->id())->count() }}</span>
                                        </a>
                                    </li>
                                    <li>
                    ...
                    <div class="nav-header">
                        ...
                        <div class="nav-menus-wrapper">
                            <ul class="nav-menu">
                                ...
                                <li><a href="{{route("searchPage")}}">Shop</a></li>
                                <li><a href="#">About Us</a></li>
                                <li><a href="{{route("webpagecontactPageView")}}">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
            ...
            <div class="rightMenu-scroll">
                ...
                <div class="right-ch-sideBar">
                    ...
                    <div class="cart_select_items py-2">
                        ...
                        @foreach (App\Models\wishlistModel::where('customer_id', Auth::guard('customerLogin')->id())->get() as $wishListInfo)
                            <div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                                <div class="cart_single d-flex align-items-center">
                                    <div class="cart_selected_single_thumb">
                                        <a href="#"><img
                                                src="{{ asset('uploads/products/preview') }}/{{ $wishListInfo->rel_to_product->product_preview_img }}"
                                                width="60" class="img-fluid" alt="" /></a>
                                    </div>
                                    <div class="cart_single_caption pl-2">
                                        <h4 class="product_title fs-sm ft-medium mb-0 lh-1">
                                            {{ $wishListInfo->rel_to_product->product_name }}</h4>
                                        <p class="mb-2"><span
                                                class="text-dark ft-medium small">{{ $wishListInfo->size_id == null ? 'N/A' : $wishListInfo->rel_to_size->SizeName }}</span>,
                                            <span
                                                class="text-dark small">{{ $wishListInfo->color_id == null ? 'N/A' : $wishListInfo->rel_to_color->ColorName }}</span>
                                        </p>
                                        <h4 class="fs-md ft-medium mb-0 lh-1">Tk
                                            {{ $wishListInfo->rel_to_product->After_discount }}/-</h4>
                                    </div>
                                </div>
                                <div class="fls_last"><a href="{{ route('wishlistitemDelete', $wishListInfo->id) }}"
                    ...
                    <div class="cart_action px-3 py-3">
                        <div class="form-group">
                            <a href="{{ route('customerWishlistPage') }}"
                                class="btn d-block full-width btn-dark-light">View
                                Whishlist</a>
                        </div>
                    </div>
            ...
            <div class="rightMenu-scroll">
                ...
                @if (App\Models\cartModel::where('customer_id', Auth::guard('customerLogin')->id())->count() == 0)
                    ...
                    <div class="bg-primary p-2">
                        <h3 class="text-light">Please, add item to the cart</h3>
                    </div>
                @else
                    <div class="right-ch-sideBar">
                                    ...
                                    <div class="cart_single d-flex align-items-center">
                                        ...
                                        <div class="cart_single_caption pl-2">
                                            ...
                                            <p class="mb-2"><span class="text-dark ft-medium small">
                                                ...
                                                </span>, <span class="text-dark small">
                        ...
                        <div class="cart_action px-3 py-3">
                            <div class="form-group">
                                <a href="{{ route('cartPage') }}" type="button"
                                    class="btn d-block full-width btn-dark-light">View
                                    Cart</a>
                            </div>
                        </div>
    ...
    @if (session('PleaseLoginWishlist'))
        <script>
            Swal.fire({
                title: 'You must have to login first to add to Wishlist',
                showClass: {
                    popup: 'animate__animated animate__fadeInDown'
                },
                hideClass: {
    ...
    @if (session('wishListAddedSuccess'))
        <script>
            const Toast = Swal.mixin({
                toast: true,
                position: 'top-end',
...
{{-- Chat box --}}
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/63c6d05947425128790e2d8d/1gn09ro4b';
            s1.charset = 'UTF-8';
