                        ...
                        <div class="killore--block-link-content">
                            <ul>
                                @foreach ($allCategoryInfo as $CategoryInfo)
                                    <li><a href="{{ route('categoriesWiseProductPage', $CategoryInfo->id) }}"><img
                        ...
                        <div class="cats_side_wrap text-center mx-auto mb-3">
                            <div class="sl_cat_01">
                                <div
                                    ...
                                    <a href="{{ route('categoriesWiseProductPage', $CategoryInfo->id) }}"
                                        class="d-block"><img
                                            src="{{ asset('uploads/category') }}/{{ $CategoryInfo->catagory_img }}"
                            ...
                            <div class="single_review">
                                ...
                                <div class="sng_rev_caption text-center">
                                    <div class="rev_desc mb-4">
                                        <p class="fs-md">{{ $clientReview->review }}</p>
                                    </div>
                                ...
                                <div class="text-center">
                                    ...
                                    @if ($clientReview->rel_to_orderCustomer->photo == null)
                                        <img width="50px" height="50px" class="mx-auto d-block mb-3 rounded-circle"
                                            src="{{ Avatar::create($clientReview->rel_to_orderCustomer->name)->toBase64() }}" />
                                    @else
                                        <img id="profileImageView"
                                            src="{{ asset('uploads/CustomerProfile/') }}/{{ $clientReview->rel_to_orderCustomer->photo }}"
                                            width="50px" height="50px" class="mx-auto d-block mb-3 rounded-circle" alt="" />
                                    @endif

                                    </span>

                                    <h4 class="mb-0">
                                        {{ $clientReview->rel_to_orderCustomer->name }},{{ $clientReview->rel_to_orderCustomer->country }}
                                    </h4>
                                </div>
                            </div>
                        @endforeach
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="ftr-content">
                        ...
                        @foreach ($AlltopSellingProduct as $topSellingProduct)
                            <div class="product_grid row">
                                <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                                    <div class="shop_thumb position-relative">
                                        <a class="card-img-top d-block overflow-hidden"
                                            href="{{ route('productDetails', $topSellingProduct->rel_to_product->slug) }}"><img
                                                class="card-img-top"
                                                src="{{ asset('uploads/products/preview/') }}/{{ $topSellingProduct->rel_to_product->product_preview_img }}"
                                                alt="..."></a>
                                    </div>
                                </div>
                                <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                    <div class="text-left mfliud">
                                        <div class="elso_titl"><span
                                                class="small">{{ $topSellingProduct->rel_to_product->rel_to_category->catagory_name }}</span>
                                        </div>
                                        <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a
                                                href="shop-single-v1.html">{{ $topSellingProduct->rel_to_product->product_name }}</a>
                                        </h5>
                                        <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                               ...
                                               @php
                                                ...
                                                $totalSum = 0;
                                                $totalReview =  App\Models\orderItemsModel::where("product_id", $topSellingProduct->product_id)->where("review", "!=", null)->count();


                                              $totalStar = App\Models\orderItemsModel::where("product_id", $topSellingProduct->product_id)->where("review", "!=", null)->sum("star");
                                                ...
                                                if ($totalReview == 0) {
                                                  $totalSum = 0;  
                                                   ...
                                                   $totalSum =$totalStar/$totalReview;
                                                }
                                        ...
                                        <div class="elis_rty">
                                            ...
                                            <span class="ft-medium text-muted line-through fs-md mr-2">Tk
                                                {{ $topSellingProduct->rel_to_product->product_Price }}</span>

                                            <span class="ft-bold text-danger fs-sm">Tk
                                                {{ $topSellingProduct->rel_to_product->After_discount }}</span>
                                    ...
                                    <div class="text-left mfliud">
                                        ...
                                        <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                            @php
                                                ...
                                                $totalSum = 0;
                                                $totalReview =  App\Models\orderItemsModel::where("product_id", $FeatureProductsInfo->id)->where("review", "!=", null)->count();


                                              $totalStar = App\Models\orderItemsModel::where("product_id", $FeatureProductsInfo->id)->where("review", "!=", null)->sum("star");
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="ftr-title">
                        <h4 class="ft-medium">Recent Viewed Product</h4>
                    </div>
                    <div class="ftr-content">
                        <!-- Single Item -->


                        @foreach ($AllrecentViewedProduct as $recentViewedProduct)
                            <div class="product_grid row">
                                <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                                    <div class="shop_thumb position-relative">
                                        <a class="card-img-top d-block overflow-hidden"
                                            href="{{ route('productDetails', $recentViewedProduct->slug) }}"><img
                                                class="card-img-top"
                                                src="{{ asset('uploads/products/preview/') }}/{{ $recentViewedProduct->product_preview_img }}"
                                                alt="..."></a>
                                    </div>
                                </div>
                                <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                    <div class="text-left mfliud">
                                        <div class="elso_titl"><span
                                                class="small">{{ $recentViewedProduct->rel_to_category->catagory_name }}</span>
                                        </div>
                                        <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a
                                                href="shop-single-v1.html">{{ $recentViewedProduct->product_name }}</a>
                                        </h5>
                                        <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                            @php

                                                $totalSum = 0;
                                                $totalReview =  App\Models\orderItemsModel::where("product_id", $recentViewedProduct->id)->where("review", "!=", null)->count();


                                              $totalStar = App\Models\orderItemsModel::where("product_id", $recentViewedProduct->id)->where("review", "!=", null)->sum("star");
                                        ...
                                        <div class="elis_rty">
                                            ...
                                            <span class="ft-medium text-muted line-through fs-md mr-2">Tk
                                                {{ $recentViewedProduct->product_Price }}</span>

                                            <span class="ft-bold text-danger fs-sm">Tk
                                                {{ $recentViewedProduct->After_discount }}</span>
