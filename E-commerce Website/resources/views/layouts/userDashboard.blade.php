...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('userDashboardAsset/vendor/chartist/css/chartist.min.css') }}">
    <link href="{{ asset('userDashboardAsset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}"
        rel="stylesheet">
    <link href="{{ asset('userDashboardAsset/vendor/owl-carousel/owl.carousel.css') }}" rel="stylesheet">
    <link href="{{ asset('userDashboardAsset/css/style.css') }}" rel="stylesheet">
    <link
...
<body>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                     ...
                     <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route("productViewPage")}}">Product List</a></li>
                            {{-- <li><a href="{{route("catagory_trash_bin")}}">Trash bin</a></li> --}}
                     ...
                     <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('addSizePage') }}">Add Size</a></li>
                            <li><a href="{{route("addColorPage")}}">Add Color</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Product Trucking</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('statusUpdatePage') }}">Status Update</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('roleMangementPage') }}">Apply role</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route("contactPageView")}}">Add Contact Info</a></li>
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('userDashboardAsset/vendor/global/global.min.js') }}"></script>
    <script src="{{ asset('userDashboardAsset/vendor/bootstrap-select/dist/js/bootstrap-select.min.js') }}"></script>
    <script src="{{ asset('userDashboardAsset/vendor/chart.js/Chart.bundle.min.js') }}"></script>
    <script src="{{ asset('userDashboardAsset/js/custom.min.js') }}"></script>
    <script src="{{ asset('userDashboardAsset/js/deznav-init.js') }}"></script>
    <script src="{{ asset('userDashboardAsset/vendor/owl-carousel/owl.carousel.js') }}"></script>
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.12.1/js/jquery.dataTables.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.js"></script>


    <!-- Chart piety plugin files -->
    <script src="{{ asset('userDashboardAsset/vendor/peity/jquery.peity.min.js') }}"></script>

    <!-- Apex Chart -->
    <script src="{{ asset('userDashboardAsset/vendor/apexchart/apexchart.js') }}"></script>

    <!-- Dashboard 1 -->
    <script src="{{ asset('userDashboardAsset/js/dashboard/dashboard-1.js') }}"></script>
    <script>
