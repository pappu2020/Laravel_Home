...
class cartController extends Controller
{
  function cartInsert(Request $req)
  {
    ...
    //Wishlist insert
      ...
      if (Auth::guard("customerLogin")->check()) {
        ...
        return back()->with("wishListAddedSuccess", "Product added to wishlist successfully");

          
      } else {
        return redirect()->route("customerLoginRegPage")->with("PleaseLoginWishlist", "You must have to login first to add to cart");
      }
  ...
  function wishlistitemDelete($wishlistitemDeleteId)
  {

    wishlistModel::find($wishlistitemDeleteId)->delete();
    return back();
  }
