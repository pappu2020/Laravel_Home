    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-8">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-row bd-highlight mb-3">
                                                ...
                                                <div class=" bd-highlight"><a href="{{route("Homedelete",$homeData->id)}}"
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Ssocial sites Info</h5>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col">Sl</th>
                                ...
                                @foreach ($homeAllSocialDataClient as $key => $homeSocialDataClient)
                                    <tr>
                                        ...
                                        <td><div class="d-flex flex-row bd-highlight mb-3">
                                                ...
                                                <div class=" bd-highlight"><a href="{{route("homeSocialDeletePage",$homeSocialDataClient->id)}}"
                                                        class="btn btn-danger"><span><svg xmlns="http://www.w3.org/2000/svg"
                                                                width="16" height="16" fill="currentColor"
                                                                class="bi bi-trash3" viewBox="0 0 16 16">
                                                                <path
