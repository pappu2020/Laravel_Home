                            ...
                            <div class="ord_list_body text-left">
                                ...
                                @foreach (App\Models\orderItemsModel::where('order_id', $OrderItemsBills->order_id)->get() as $orderProduct)
                                    <div class="row align-items-center justify-content-center m-0 py-4 br-bottom">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-12 ml-auto">
                                          
                                            <div class="delv_status">


                                                <Span class="status_heading">status: </Span> @php
                                                    $satusMessgae = '';
                                                    if ($OrderItemsBills->status == 0) {
                                                        $satusMessgae = 'Order is placed';
                                                    } elseif ($OrderItemsBills->status == 1) {
                                                        $satusMessgae = 'Package being prepared';
                                                    } elseif ($OrderItemsBills->status == 2) {
                                                        $satusMessgae = 'Reached logistics facility';
                                                    } elseif ($OrderItemsBills->status == 3) {
                                                        $satusMessgae = 'Reached our warehouse';
                                                    } elseif ($OrderItemsBills->status == 4) {
                                                        $satusMessgae = 'Shiped';
                                                    } elseif ($OrderItemsBills->status == 5) {
                                          ...
                                          @if ($OrderItemsBills->status == 0) bg-info
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-12 ml-auto">
                                            <a href="{{route("downloadInvoice",$orderProduct->id)}}" class="btn btn-info">Download Invoice</a>
