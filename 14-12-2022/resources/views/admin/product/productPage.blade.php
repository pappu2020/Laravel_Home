                            ...
                            <form action="{{ route('productInsert') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group col-lg-12 mt-3">
                                        ...
                                        <textarea class="form-control border border-dark" id="summernote" name="product_Long_desp" aria-label="With textarea"></textarea>
                                    </div>


                                    <div class="col-lg-6 mt-3">
                                        <label for="product_preview_img" class="form-label">Preview Image</label>
                                        <img src="" alt="" width="200px" height="100px" class="mt-2 ml-3"
                                            id="productImageView">
                                        <input type="file" name="product_preview_img"
                                            class="form-control border border-dark mt-3"
                                            onchange="document.getElementById('productImageView').src = window.URL.createObjectURL(this.files[0])">
                                    </div>
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        ...
                                        <input type="file" multiple name="product_Thumbnails_img[]"
                                            class="form-control border border-dark mt-3"
                                            onchange="document.getElementById('productthumbImageView').src = window.URL.createObjectURL(this.files[0])">
                                    </div>
